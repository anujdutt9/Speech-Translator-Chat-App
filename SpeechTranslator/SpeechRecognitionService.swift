...
let API_KEY : String = "YOUR-GOOGLE-CLOUD-SPEECH-TO-TEXT-API-KEY"
...
class SpeechRecognitionService {
  ...
  static let sharedInstance = SpeechRecognitionService()
    ...
    func streamAudioData(_ audioData: NSData, language: String, completion: @escaping SpeechRecognitionCompletionHandler) {
    if (!streaming) {
